...
class MailgunControllerTest extends WebTestCase
{
    public function testShowOverviewAction()
    {
        ...
        $this->assertEquals(1, $crawler->filter("li li a:contains('unsubscribe requests by users ($unsubscribed)')")->count(), "'unsubscribe requests by users ($unsubscribed)' expected on page.");
